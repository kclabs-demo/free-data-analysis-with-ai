...
DATASET_ID = "analysis"
TABLE_ID = "language_reputation_by_tag"
...
print("Creating aggregated table in BigQuery...")
...
with open("analysis/language-reputation/results.json", "w") as f:
    json.dump(output_json, f, indent=2)
print("Saved: analysis/language-reputation/results.json")
...
with open("analysis/language-reputation/results.md", "w") as f:
    f.write(markdown)
print("Saved: analysis/language-reputation/results.md")
